...
const config: Config = {
  ...
  theme: {
  	extend: {
  		...
  		backgroundImage: {
  			'gradient-balls-top-left': 'linear-gradient(30deg, rgba(41, 8, 72, 0.05) 15%, rgba(8, 39, 72, 0) 50%)',
  			'gradient-balls-top-right': 'linear-gradient(347deg, rgba(8, 39, 72, 0.05) 20%, rgba(8, 39, 72, 0) 60%)',
  			'gradient-balls-bottom-left': 'linear-gradient(200deg, rgba(8, 39, 72, 0.05) 30%, rgba(8, 39, 72, 0) 60%)'
  		}
  	},
  	fontFamily: {
  		display: [
