    ...
    >
      ...
      <section className="relative -mt-32 w-full">
        <div className="mx-auto flex flex-col gap-12 md:flex-row md:items-center">
          <div className="w-72 animate-fade-right lg:w-1/2">
            <Image
      ...
      <section className="relative z-10 mt-16 lg:mt-32">
        <div className="mx-auto flex flex-col-reverse items-center gap-12 md:flex-row">
          ...
          <div className="w-72 animate-fade-left self-end lg:w-1/2">
            <Image
      ...
      <section className="relative">
        <Image
          src="home/rocket.svg"
          alt="Rocket"
          className="-z-10 mx-auto mb-8 h-auto w-screen animate-fade-up xl:-mt-[140px]"
          width={1000}
          height={1000}
        />
