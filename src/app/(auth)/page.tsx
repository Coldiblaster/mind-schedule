...
export default function Auth() {
  ...
  return (
    <>
      <div
        className={`transform ${isRegister ? 'md:translate-x-full' : 'md:translate-x-0'} fixed h-svh w-full transition-transform duration-700 ease-in-out md:relative md:w-1/2`}
      >
